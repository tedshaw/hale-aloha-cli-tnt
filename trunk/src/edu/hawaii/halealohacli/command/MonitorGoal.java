...
public class MonitorGoal implements Command {
  ...
  public MonitorGoal(WattDepotClient client) {
    ...
    commandDescription =
        "Prints out a timestamp, the current power being consumed by the [tower"
            + " | lounge], and whether or not the lounge is meeting its power conservation goal.";
  ...
  public void execute(String... args) throws InvalidArgumentException {
    ...
    if (sb == null || sb.toString().isEmpty()) {
      ...
      try {
        ...
        final String FAIL =
            "I'm sorry, you are not currently meeting your power consumption "
                + "goal. Please conserve a little more energy.";
        double baseline = 0;
  ...
  public static StringBuilder checkAll(String[] args) throws InvalidArgumentException {
    ...
    if (!source.matches(regex)) {
      sb.append("Please enter a valid tower or lounge name. "
